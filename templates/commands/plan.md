...
3. **Execute plan workflow**: Follow the structure in IMPL_PLAN template to fill all sections:
   ...
   - **Write the completed plan to `IMPL_PLAN` path** (overwrite the template)
